...
O comando \lstinline{SET} é utilizado para definir um estado lógico específico em variáveis internas do PLC. Esse comando é útil para inicializar variáveis ou para acionar estados específicos em situações de controle.
...
Ou em várias usando \lstinline{MPS}, \lstinline{MRD} e \lstinline{MPP}.

\lstinputlisting[
	language=C,
	caption={Seção de entrada com multiplas saída em lista de instrução},
	sourcePrefix={Fonte: },
	source={Do autor.},
	firstline=64,
	lastline=70,
	label=code:ilmultiple
]{code/il.txt}
