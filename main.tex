...
\titulo{Desenvolvimento de um método e sistema para trans compilação e simulação de redes de petri para utilização em  controladores lógicos industriais}              								% titulo do trabalho
...
\def\PalavrasChave{	                                 		% palavras chave para o resumo
	redes de petri; automação industrial; software.
} 
\def\Keywords{												% palavras chave para o resumo em inglês
	petri nets; industrial automation; software.
}
